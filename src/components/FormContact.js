    ...
    return(
        <section id="contact" className="text-gray-600 body-font">
            <div className="flex flex-col items-center text-center justify-center">
                <h1 className="text-3xl font-medium title-font text-gray-900 dark:text-white ">Contact me</h1>
                <div className="w-12 h-1 bg-rose-500 rounded mt-2 mb-4"></div>
            </div>
            <div className="container w-7/12 py-24 mx-auto">
                <form className="px-3" ref={formRef} onSubmit={handleSubmit}>
                    <div className="flex">
                        <div className="w-full mr-2">
                            <label className="uppercase text-xs font-bold mb-2">Name</label>
                            <input 
                                className="w-full py-3 px-4 bg-slate-800 text-slate-100 focus:outline-none focus:border focus:border-rose-500 placeholder:text-slate-500" 
                                type="text" 
                                name="name"
                    ...
                    <div className="w-full mt-6">
                        ...
                        <textarea 
                            className="w-full h-32 py-3 px-4 bg-slate-800 text-slate-100 focus:outline-none focus:border focus:border-rose-500 placeholder:text-slate-500" 
                            placeholder="Message"
                            name="message"
